 ...
 */
var findAllPSiblings = (where) => (
    [...where.children].filter(({ nextElementSibling }) => (nextElementSibling && nextElementSibling.tagName === 'P'))
);
 ...
 */
var deleteTextNodesRecursive = (where) => {
